...
AccountModel _accountModelDeserialize(
  ...
  object.type =
      _AccountModeltypeValueEnumMap[reader.readStringOrNull(offsets[8])] ??
          AccountType.bank;
...
const _AccountModeltypeValueEnumMap = {
  ...
  r'fixedDeposit': AccountType.fixedDeposit,
  r'loan': AccountType.loan,
  r'creditCard': AccountType.creditCard,
  r'family': AccountType.family,
};
...
extension AccountModelQuerySortBy
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> sortByBankName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'bankName', Sort.asc);
    });
  }

  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> sortByBankNameDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AccountModelQuerySortThenBy
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> thenByBankName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'bankName', Sort.asc);
    });
  }

  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> thenByBankNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'bankName', Sort.desc);
    });
  }
...
extension AccountModelQueryWhereDistinct
  ...
  QueryBuilder<AccountModel, AccountModel, QDistinct> distinctByBankName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension AccountModelQueryProperty
  ...
  QueryBuilder<AccountModel, String?, QQueryOperations> bankNameProperty() {
    return QueryBuilder.apply(this, (query) {

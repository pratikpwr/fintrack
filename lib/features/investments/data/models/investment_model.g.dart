...
const InvestmentModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'type': PropertySchema(
      ...
      name: r'type',
      type: IsarType.string,
      enumMap: _InvestmentModeltypeEnumValueMap,
    ),
...
void _investmentModelSerialize(
  ...
  writer.writeLong(offsets[3], object.linkedAccountId);
...
InvestmentModel _investmentModelDeserialize(
  ...
  object.linkedAccountId = reader.readLongOrNull(offsets[3]);
  ...
  object.type =
      _InvestmentModeltypeValueEnumMap[reader.readStringOrNull(offsets[10])] ??
...
P _investmentModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 9:
      return (reader.readStringOrNull(offset)) as P;
    case 10:
      return (_InvestmentModeltypeValueEnumMap[
...
const _InvestmentModeltypeEnumValueMap = {
  r'stock': r'stock',
...
const _InvestmentModeltypeValueEnumMap = {
  r'stock': InvestmentType.stock,
  r'mutualFund': InvestmentType.mutualFund,
  r'etf': InvestmentType.etf,
  r'bond': InvestmentType.bond,
  r'gold': InvestmentType.gold,
  r'realEstate': InvestmentType.realEstate,
  r'crypto': InvestmentType.crypto,
  r'other': InvestmentType.other,
};
...
extension InvestmentModelQueryWhereSort
  ...
  QueryBuilder<InvestmentModel, InvestmentModel, QAfterWhere> anyIsActive() {
    return QueryBuilder.apply(this, (query) {
...
extension InvestmentModelQueryWhere
  ...
  QueryBuilder<InvestmentModel, InvestmentModel, QAfterWhereClause> nameEqualTo(
      String name) {
    return QueryBuilder.apply(this, (query) {
...
extension InvestmentModelQueryProperty
  ...
  QueryBuilder<InvestmentModel, bool, QQueryOperations> isActiveProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<InvestmentModel, double, QQueryOperations> quantityProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<InvestmentModel, InvestmentType, QQueryOperations>
      typeProperty() {
    return QueryBuilder.apply(this, (query) {

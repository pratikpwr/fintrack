...
const TransactionModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'paymentMethod': PropertySchema(
      ...
      type: IsarType.string,
      enumMap: _TransactionModelpaymentMethodEnumValueMap,
    ),
...
int _transactionModelEstimateSize(
  ...
  {
    final value = object.creditCardId;
    if (value != null) {
      bytesCount += 3 + value.length * 3;
    }
  }
  ...
  {
    final value = object.familyMemberId;
    if (value != null) {
      bytesCount += 3 + value.length * 3;
    }
  }
...
void _transactionModelSerialize(
  ...
  writer.writeString(offsets[4], object.creditCardId);
  writer.writeDateTime(offsets[5], object.date);
  writer.writeString(offsets[6], object.description);
  writer.writeString(offsets[7], object.familyMemberId);
  writer.writeString(offsets[8], object.importBatchId);
  writer.writeString(offsets[9], object.notes);
  writer.writeString(offsets[10], object.paymentMethod.name);
...
TransactionModel _transactionModelDeserialize(
  ...
  object.creditCardId = reader.readStringOrNull(offsets[4]);
  object.date = reader.readDateTime(offsets[5]);
  object.description = reader.readStringOrNull(offsets[6]);
  object.familyMemberId = reader.readStringOrNull(offsets[7]);
  object.id = id;
  object.importBatchId = reader.readStringOrNull(offsets[8]);
  object.notes = reader.readStringOrNull(offsets[9]);
  object.paymentMethod = _TransactionModelpaymentMethodValueEnumMap[
          reader.readStringOrNull(offsets[10])] ??
      PaymentMethod.cash;
  object.source = _TransactionModelsourceValueEnumMap[
...
P _transactionModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 9:
      return (reader.readStringOrNull(offset)) as P;
    case 10:
      return (_TransactionModelpaymentMethodValueEnumMap[
              reader.readStringOrNull(offset)] ??
          PaymentMethod.cash) as P;
    case 11:
      return (_TransactionModelsourceValueEnumMap[
              reader.readStringOrNull(offset)] ??
          TransactionSource.manual) as P;
    case 12:
...
const _TransactionModelpaymentMethodEnumValueMap = {
  r'cash': r'cash',
...
const _TransactionModelpaymentMethodValueEnumMap = {
  r'cash': PaymentMethod.cash,
  r'bankTransfer': PaymentMethod.bankTransfer,
  r'upi': PaymentMethod.upi,
  r'creditCard': PaymentMethod.creditCard,
  r'debitCard': PaymentMethod.debitCard,
  r'cheque': PaymentMethod.cheque,
  r'other': PaymentMethod.other,
};
const _TransactionModelsourceEnumValueMap = {
  r'manual': r'manual',
  r'excelImport': r'excelImport',
  r'smsImport': r'smsImport',
  r'recurring': r'recurring',
};
const _TransactionModelsourceValueEnumMap = {
  r'manual': TransactionSource.manual,
  r'excelImport': TransactionSource.excelImport,
  r'smsImport': TransactionSource.smsImport,
  r'recurring': TransactionSource.recurring,
};
const _TransactionModeltypeEnumValueMap = {
  r'income': r'income',
  r'expense': r'expense',
  r'transfer': r'transfer',
  r'familyTransfer': r'familyTransfer',
  r'investment': r'investment',
  r'loanPayment': r'loanPayment',
...
const _TransactionModeltypeValueEnumMap = {
  ...
  r'familyTransfer': TransactionType.familyTransfer,
  r'investment': TransactionType.investment,
  r'loanPayment': TransactionType.loanPayment,
  r'adjustment': TransactionType.adjustment,
};
...
extension TransactionModelQueryFilter
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterFilterCondition>
      creditCardIdContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'creditCardId',
        value: value,
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterFilterCondition>
      creditCardIdMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'creditCardId',
        wildcard: pattern,
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterFilterCondition>
      familyMemberIdContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'familyMemberId',
        value: value,
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterFilterCondition>
      familyMemberIdMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'familyMemberId',
        wildcard: pattern,
...
extension TransactionModelQueryWhereDistinct
  ...
  QueryBuilder<TransactionModel, TransactionModel, QDistinct>
      distinctByCreditCardId({bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'creditCardId', caseSensitive: caseSensitive);
    });
  }
  ...
  QueryBuilder<TransactionModel, TransactionModel, QDistinct>
      distinctByFamilyMemberId({bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionModelQueryProperty
  ...
  QueryBuilder<TransactionModel, PaymentMethod, QQueryOperations>
